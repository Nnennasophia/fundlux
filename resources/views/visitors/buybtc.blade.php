...
<main class="crypto-contents whatweinvestin-page">
	<!-- contents of the page -->
 <section>
 	<div class="paragraph">
 		<h1>cryptocurrencies</h1>
 		<p><a href="https://www.tradingview.com/markets/cryptocurrencies/prices-all/" target="_blank">cryptocurrency market chart</a></p>
 		<p>
 	...
 	<div class="paragraph">
 		<h4>Cryptocurrency Benefits and Drawbacks</h4>
 		<ul>
 			<li>
...
Our Mining equipments are powered by a setup of optimized GPUs (graphic processing units). These GPUs are placed in ‘Rigs’ which are specifically designed to house as much hashing power as efficiently as possible. The miner's software is configured for maximum performance by mining Kernels (hardware operating systems) like that we’ve developed in-house.
 	...
 	<div class="paragraph">
 		<h2>our mining rings</h2>
 		<div class="flex">
 		<div class="img-container">
 			<img src="{{asset("images/crypto-mining-1.jpg")}}" alt="mining image">
 		</div>
 		<div class="img-container">
 			<img src="{{asset("images/crypto-mining-2.jpg")}}" alt="mining image">
 		</div>
 		<div class="img-container">
 			<img src="{{asset("images/bitcoin-mining-1.jpg")}}" alt="mining image">
 		</div>
 		<div class="img-container">
 			<img src="{{asset("images/bitcoin-mining-2.jpg")}}" alt="mining image">
 		</div>
 	</div>
 	</div>
 </section>
