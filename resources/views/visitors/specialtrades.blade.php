...
<main class="special-trades-contents whatweinvestin-page">
	...
	<section>
		...
		<div class="paragraph">
			<h3>What is ERC 20 and what does it provide for an Fundlux Investor &quest;</h3>
			<p>
				...
				<br>
				And that is why at Fundlux Financial Management we tailor our clients need and create a diversified portfolio inclusive of new and high prospective offerings in the digital space.
			</p>
		</div>
		<div class="paragraph">
			...
			<p>
				{{$compd? $compd->Companyname: 'Fundlux'}} Financial Management board members are in connection with great development teams precisely developing cryptocurrency using the ERC 20 token standard and history has proven to give one of the best projects yields.
			</p>
			<p>
