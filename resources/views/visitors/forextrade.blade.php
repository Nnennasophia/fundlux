...
Note that you’ll see the terms:<i> FX, forex, foreign-exchange market, and currency market. These terms are synonymous and all refer to the forex market.</i>
        ...
        <div class="paragraph">
        	...
        	<ul>
        		<li>
        			Set up an account: You will need a forex trading account at a brokerage to get started with forex trading. Fundlux financial management does not charge commissions. Instead, we make money through spreads (also known as pips) between the buying and selling prices.
        		</li>
        		<li>
